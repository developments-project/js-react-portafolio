...
{ name: 'Java', icon: <FaJava className={styles.javaIcon}/>, color: '#FF3B30', code: [
    { line: <><span className={styles['java-keyword']}>class</span> Main {'{'}</>, delay: 0.5, duration: 0.8, steps: 12 },
    { line: <>{' '}<span className={styles['java-keyword']}>public void</span> <span className={styles['java-methodName']}>main()</span> {'{'}</>, delay: 1.5, duration: 1.5, steps: 28 },
    { line: <>{'  '}System.out.println(<span className={styles['java-string']}>"¡Hola, bienvenido!"</span>);</>, delay: 3.0, duration: 1.5, steps: 15 },
    { line: <>{' }'}</>, delay: 5.1, duration: 0.5, steps: 7 },
    { line: <>{'}'}</>, delay: 5.7, duration: 0.5, steps: 10 },

  ]},
  { name: 'Python', icon: <FaPython className={styles.pythonIcon}/>, color: '#F7DF1E', code: [
    { line: <><span className={styles['java-keyword']}>def</span> <span className={styles['py-function']}>main</span>():</>, delay: 0.5, duration: 0.8, steps: 10 },
  ...
  { name: 'C++', icon: <SiCplusplus className={styles.cppIcon}/>, color: '#006fc4', code: [
    ...
    { line: <>{'  '}std::cout {'<<'} <span className={styles['cpp-string']}>"¡Hola, bienvenido!"</span>;</>, delay: 3.1, duration: 1.5, steps: 28 },
