...
  ]},
  { name: 'Python', icon: <FaPython className={styles.pythonIcon}/>, color: '#F7DF1E', code: [
    ...
    { line: <>{'  '}<span className={styles['.java-keyword']}>print</span>(<span className={styles['py-string']}>"¡Hola, bienvenido!"</span>)</>, delay: 1.5, duration: 1.5, steps: 25 },
  ...
  { name: 'C++', icon: <SiCplusplus className={styles.cppIcon}/>, color: '#006fc4', code: [
    { line: <><span className={styles['cpp-preprocessor']}>#include{'<iostream>'}</span></>, delay: 0.5, duration: 1.2, steps: 15 },
    { line: <><span className={styles['cpp-keyword']}>int </span>main(){'{'}</>, delay: 1.9, duration: 1.0, steps: 15 },
    { line: <>{''} std::cout {'<<'} <span className={styles['cpp-string']}>"¡Hola, bienvenido!"</span>;</>, delay: 3.1, duration: 1.4, steps: 15 },
    { line: <>{'}'}</>, delay: 4.6, duration: 0.5, steps: 10 },
  ]},
